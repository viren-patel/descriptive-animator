...
public interface TweenModelBuilder<T> {
  ...
  /**
   * Rotates the shape from the initial theta to the end theta. Thetas are along the x axis.
   *
   * @param name      shape name
   * @param fromTheta original angle
   * @param toTheta   end angle
   * @param startTime start time of animation
   * @param endTime   end time
   */
  TweenModelBuilder<T> addRotate(String name, float fromTheta, float toTheta, int startTime,
                                 int endTime);
